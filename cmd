python e1_batch_tabular.py --dataset breast_cancer --tau_diag --diag_n 30 --diag_oracle --rivals
python e1_batch_image.py benchmark_50 --N 500 --tau_diag --diag_n 30 --diag_lo 0.5 --diag_hi 64 --rivals
